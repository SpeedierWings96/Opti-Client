...
public class OptiTranslator implements SynchronousResourceReloader
{
	private final OptiClient OPTI = OptiClient.INSTANCE;
	 ...
	 * or into English if the "Force English" setting is enabled. Both OPTI and
	 ...
	 * the current language. Both OPTI and vanilla translations are supported.
	 */
	...
	{
		return OPTI.getOtfs().translationsOtf.getForceEnglish().isChecked();
	}
	
	/**
	 * Returns a translation storage for Minecraft's English strings, regardless
	 * of the current language. Does not include any of Opti's translations.
	 */
	...
	public Map<String, String> getOPTIsCurrentLanguage()
	{
