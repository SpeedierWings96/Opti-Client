 ...
 */
package net.opticlient.other_feature;
...
import net.opticlient.other_features.*;
...
public final class OtfList
{
	...
	public final OptiCapesOtf OptiCapesOtf = new OptiCapesOtf();
	public final OptiLogoOtf OptiLogoOtf = new OptiLogoOtf();
	...
	public OtfList()
	{
		...
		{
			String message = "Initializing other OPTI features";
