...
import net.opticlient.other_features.TabGuiOtf;
...
public final class TabGui implements KeyPressListener
{
	...
	private final TabGuiOtf tabGuiOtf = OptiClient.INSTANCE.getOtfs().tabGuiOtf;
	...
	public TabGui()
	{
		OPTI.getEventManager().add(KeyPressListener.class, this);
	...
	public void render(DrawContext context, float partialTicks)
	{
		...
		int textY = 1;
		int txtColor = OPTI.getGui().getTxtColor();
