...
import net.opticlient.events.MouseScrollListener;
...
import net.opticlient.settings.TextFieldSetting;
...
public final class ZoomOtf extends OtherFeature implements MouseScrollListener
{
	...
	private final TextFieldSetting keybind = new TextFieldSetting("Keybind",
		"Determines the zoom keybind.\n\n"
			+ "Instead of editing this value manually, you should go to OPTI"
	...
	public ZoomOtf()
	{
		super("Zoom", "Allows you to zoom in.\n"
			...
			+ "Go to OPTI Options -> Zoom to change this keybind.");
		addSetting(level);
		addSetting(scroll);
