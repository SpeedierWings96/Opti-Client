...
import net.opticlient.options.KeybindManagerScreen;
...
public final class KeybindManagerOtf extends OtherFeature
{
	...
	{
		super("Keybinds",
			"This is just a shortcut to let you open the Keybind Manager from within the GUI. Normally you would go to OPTI Options > Keybinds.");
	}
