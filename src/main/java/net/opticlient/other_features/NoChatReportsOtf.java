	...
	implements UpdateListener, ChatInputListener
{
	...
	public void onReceivedMessage(ChatInputEvent event)
	{
		...
		ClickEvent clickEvent = new ClickEvent.OpenUrl(
			URI.create("https://www.OptiClient.net/chat-disabled-mpk/"));
	...
	{
		if(!OPTI.isEnabled() || MC.isInSingleplayer())
			return indicator;
	...
	{
		return isEnabled() && OPTI.isEnabled() && !MC.isInSingleplayer();
	}
	
	@Override
	public String getPrimaryAction()
	{
		return OPTI.translate("button.OPTI.nochatreports."
