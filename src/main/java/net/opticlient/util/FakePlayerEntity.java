...
{
	private final ClientPlayerEntity player = OptiClient.MC.player;
	private final ClientWorld world = OptiClient.MC.world;
	private PlayerListEntry playerListEntry;
	
	public FakePlayerEntity()
	{
		super(OptiClient.MC.world, OptiClient.MC.player.getGameProfile());
