...
import net.opticlient.other_features.ZoomOtf;
...
public class ZoomManagerScreen extends Screen implements PressAKeyCallback
{
	...
	public void init()
	{
		...
		ZoomOtf zoom = OPTI.getOtfs().zoomOtf;
	...
	{
		ZoomOtf zoom = OptiClient.INSTANCE.getOtfs().zoomOtf;
		CheckboxSetting scroll = zoom.getScrollSetting();
		...
		float partialTicks)
	{
		...
		context.drawTextWithShadow(textRenderer,
			...
			height / 4 + 44, OptiColors.VERY_LIGHT_GRAY);
	...
	{
		OptiClient.INSTANCE.getOtfs().zoomOtf.setBoundKey(key);
