...
public final class KeybindProfilesScreen extends Screen
{
	...
	public void init()
	{
		listGui = new ListGui(client, this,
			OptiClient.INSTANCE.getKeybinds().listProfiles());
	...
	private void openFolder()
	{
		Util.getOperatingSystem().open(
			OptiClient.INSTANCE.getKeybinds().getProfilesFolder().toFile());
	}
	...
	private void newProfile(String name)
	{
		...
		try
		{
			OptiClient.INSTANCE.getKeybinds().saveProfile(name);
	...
	private void loadSelected()
	{
		...
		try
		{
			...
			OptiClient.INSTANCE.getKeybinds().loadProfile(fileName);
			client.setScreen(prevScreen);
