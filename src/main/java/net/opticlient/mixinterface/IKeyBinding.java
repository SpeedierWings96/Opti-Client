 ...
 */
package net.opticlient.mixinterface;
...
public interface IKeyBinding
{
	 ...
	 */
	@Deprecated
	public void opti_resetPressedState();
	
	/**
	 * @deprecated Use {@link #simulatePress()} instead.
	 */
	@Deprecated
	public void opti_simulatePress(boolean pressed);
}
