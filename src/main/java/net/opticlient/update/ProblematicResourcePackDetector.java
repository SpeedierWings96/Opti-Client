...
import net.opticlient.util.StreamUtils;

public final class ProblematicResourcePackDetector implements UpdateListener
{
	private static final String WARNING_MESSAGE =
		"VanillaTweaks \"Twinkling Stars\" pack detected. This resource pack is known to cause problems with OPTI!";
	...
	{
		if(OptiClient.INSTANCE.isEnabled() && isTwinklingStarsInstalled())
	...
	private boolean isTwinklingStarsInstalled()
	{
		Collection<ResourcePackProfile> enabledProfiles =
			OptiClient.MC.getResourcePackManager().getEnabledProfiles();
