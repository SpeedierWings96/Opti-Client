...
public final class OptiE2ETestClient implements ModInitializer
{
	@Override
	public void onInitialize()
	{
		if(System.getProperty("Opti.e2eTest") == null)
			return;
		
		Thread.ofVirtual().name("Opti End-to-End Test")
	...
	{
		System.out.println("Starting Opti End-to-End Tests");
