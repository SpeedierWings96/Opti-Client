 ...
 */
package net.opticlient.altmanager;
...
public final class Encryption
{
	...
	public Encryption(Path encFolder) throws IOException
	{
		...
		KeyPair rsaKeyPair =
			getRsaKeyPair(encFolder.resolve("Opti_rsa_public.txt"),
				encFolder.resolve("Opti_rsa_private.txt"));
		
		SecretKey aesKey =
			getAesKey(encFolder.resolve("Opti_aes.txt"), rsaKeyPair);
	...
	private Path createEncryptionFolder(Path encFolder) throws IOException
	{
		...
		String readmeText = "DO NOT SHARE THESE FILES WITH ANYONE!\r\n"
			...
			+ "If you do, Opti's Alt Manager can no longer read your alt list and will replace it with a blank one.\r\n"
	...
	public static Path chooseEncryptionFolder()
	{
		...
		String encFolderName = ".OPTI encryption";
	...
	public static void migrateEncryptionFolder(Path oldFolder, Path newFolder)
	{
		...
		{
			CrashReport report =
				CrashReport.create(e, "Migrating OPTI encryption folder");
