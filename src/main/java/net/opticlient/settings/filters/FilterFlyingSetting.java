 ...
 */
package net.opticlient.settings.filters;
...
import net.opticlient.settings.filterlists.EntityFilterList.EntityFilter;
	...
	implements EntityFilter
{
	...
	public boolean test(Entity e)
	{
		...
		return !OptiClient.MC.world.isSpaceEmpty(box);
	}
	...
	public static FilterFlyingSetting genericCombat(double value)
	{
		return new FilterFlyingSetting(
			"description.opti.setting.generic.filter_flying_combat", value);
	}
}
