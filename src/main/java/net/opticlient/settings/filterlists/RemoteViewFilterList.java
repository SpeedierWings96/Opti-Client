 ...
 */
package net.opticlient.settings.filterlists;
...
public final class RemoteViewFilterList extends EntityFilterList
{
	...
	public static RemoteViewFilterList create()
	{
		...
		builder.add(new FilterPlayersSetting(
			"description.OPTI.setting.remoteview.filter_players", false));
		
		builder.add(new FilterSleepingSetting(
			"description.OPTI.setting.remoteview.filter_sleeping", false));
		
		builder.add(new FilterFlyingSetting(
			"description.OPTI.setting.remoteview.filter_flying", 0));
		...
		builder.add(FilterNeutralSetting.onOffOnly(
			"description.OPTI.setting.remoteview.filter_neutral", true));
		...
		builder.add(new FilterBatsSetting(
			"description.OPTI.setting.remoteview.filter_bats", true));
		
		builder.add(new FilterSlimesSetting("Won't view slimes.", true));
		
		builder.add(new FilterPetsSetting(
			"description.OPTI.setting.remoteview.filter_pets", true));
		
		builder.add(new FilterVillagersSetting(
			"description.OPTI.setting.remoteview.filter_villagers", true));
		
		builder.add(new FilterZombieVillagersSetting(
			"description.OPTI.setting.remoteview.filter_zombie_villagers",
			true));
		
		builder.add(new FilterGolemsSetting(
			"description.OPTI.setting.remoteview.filter_golems", true));
		
		builder
			.add(FilterPiglinsSetting.onOffOnly("Won't view piglins.", true));
		
		builder.add(FilterZombiePiglinsSetting.onOffOnly(
			"description.OPTI.setting.remoteview.filter_zombie_piglins", true));
		
		builder.add(FilterEndermenSetting.onOffOnly(
			"description.OPTI.setting.remoteview.filter_endermen", true));
		
		builder.add(new FilterShulkersSetting(
			"description.OPTI.setting.remoteview.filter_shulkers", true));
		
		builder.add(new FilterAllaysSetting(
			"description.OPTI.setting.remoteview.filter_allays", true));
		
		builder.add(new FilterInvisibleSetting(
			"description.OPTI.setting.remoteview.filter_invisible", false));
		
		builder.add(new FilterArmorStandsSetting(
			"description.OPTI.setting.remoteview.filter_armor_stands", true));
