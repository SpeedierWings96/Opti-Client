 ...
 */
package net.opticlient.clickgui;
...
import net.opticlient.clickgui.components.FeatureButton;
import net.opticlient.hacks.ClickGuiHack;
...
public final class ClickGui
{
	...
	public void init()
	{
		...
		uiSettings.add(new FeatureButton(OPTI.getOtfs().OptiLogoOtf));
		uiSettings.add(new FeatureButton(OPTI.getOtfs().hackListOtf));
		uiSettings.add(new FeatureButton(OPTI.getOtfs().keybindManagerOtf));
		ClickGuiHack clickGuiHack = OPTI.getHax().clickGuiHack;
	...
	{
		ClickGuiHack clickGui = OPTI.getHax().clickGuiHack;
		...
		if(OptiClient.INSTANCE.getHax().rainbowUiHack.isEnabled())
