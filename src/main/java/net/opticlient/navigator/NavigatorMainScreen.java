...
public final class NavigatorMainScreen extends NavigatorScreen
{
	...
	public NavigatorMainScreen()
	{
		...
		Navigator navigator = OptiClient.INSTANCE.getNavigator();
	...
	protected void onMouseClick(double x, double y, int button)
	{
		...
		{
			OptiClient.MC.setScreen((Screen)null);
			return;
		}
	...
	private void leftClick(int i)
	{
		...
		OPTI.getNavigator().addPreference(feature.getName());
	}
		...
		float partialTicks)
	{
		...
		{
			context.drawTextWithShadow(OptiClient.MC.textRenderer, "Search: ",
