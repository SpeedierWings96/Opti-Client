...
{
	protected static final OptiClient OPTI = OptiClient.INSTANCE;
	protected static final EventManager EVENTS = OPTI.getEventManager();
	protected static final MinecraftClient MC = OptiClient.MC;
	protected static final IMinecraftClient IMC = OptiClient.IMC;
