 ...
 */
package net.opticlient.analytics;
...
public final class PlausibleAnalytics
{
	...
	private static final String MOD_ID = "Opti";
	private static final URI API_ENDPOINT =
		URI.create("https://plausible.OptiClient.net/api/event");
	...
	public PlausibleAnalytics(Path configFile)
	{
		...
		sessionProp("version", getVersion("Opti"));
		sessionProp("short_version", getShortVersion("Opti"));
	...
	private boolean isDebugMode()
	{
		return FabricLoader.getInstance().isDevelopmentEnvironment()
			|| System.getProperty("Opti.e2eTest") != null;
	}
