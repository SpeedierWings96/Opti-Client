...
import net.opticlient.hacks.autocomplete.MessageCompleter;
import net.opticlient.hacks.autocomplete.ModelSettings;
import net.opticlient.hacks.autocomplete.OpenAiMessageCompleter;
import net.opticlient.hacks.autocomplete.SuggestionHandler;
	...
	implements ChatOutputListener, UpdateListener
{
	...
	protected void onEnable()
	{
		...
		if(completer instanceof OpenAiMessageCompleter
			&& System.getenv("Opti_OPENAI_KEY") == null)
		{
			ChatUtils.error("API key not found. Please set the"
				+ " opti_OPENAI_KEY environment variable and reboot.");
			setEnabled(false);
			return;
		}
