...
import net.opticlient.hacks.mobspawnesp.HitboxCheckSetting;
import net.opticlient.settings.CheckboxSetting;
import net.opticlient.settings.ChunkAreaSetting;
import net.opticlient.settings.ChunkAreaSetting.ChunkArea;
...
import net.opticlient.util.chunk.ChunkSearcher.Result;
import net.opticlient.util.chunk.ChunkVertexBufferCoordinator;
	...
	implements UpdateListener, RenderListener
{
	...
	private final ColorSetting nightColor = new ColorSetting("Night color",
		"description.opti.setting.mobspawnesp.night_color", Color.YELLOW);
	
	private final ColorSetting dayColor = new ColorSetting("Day color",
		"description.opti.setting.mobspawnesp.day_color", Color.RED);
	...
	public void onRender(MatrixStack matrixStack, float partialTicks)
	{
		RenderLayer.MultiPhase layer =
			OptiRenderLayers.getLines(depthTest.isChecked());
