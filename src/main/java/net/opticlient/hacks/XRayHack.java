...
import net.opticlient.clickgui.screens.EditBlockListScreen;
import net.opticlient.events.GetAmbientOcclusionLightLevelListener;
import net.opticlient.events.RenderBlockEntityListener;
import net.opticlient.events.SetOpaqueCubeListener;
import net.opticlient.events.ShouldDrawSideListener;
import net.opticlient.events.UpdateListener;
import net.opticlient.hack.Hack;
import net.opticlient.mixinterface.ISimpleOption;
import net.opticlient.settings.BlockListSetting;
	...
	ShouldDrawSideListener, RenderBlockEntityListener
{
	...
	private final String renderName =
		Math.random() < 0.01 ? "X-OPTI" : getName();
	...
	protected void onDisable()
	{
		...
		// reset gamma
		FullbrightHack fullbright = OPTI.getHax().fullbrightHack;
