...
import net.opticlient.hacks.autolibrarian.BookOffer;
import net.opticlient.hacks.autolibrarian.UpdateBooksSetting;
import net.opticlient.mixinterface.IKeyBinding;
import net.opticlient.settings.BookOffersSetting;
import net.opticlient.settings.CheckboxSetting;
import net.opticlient.settings.FacingSetting;
	...
	implements UpdateListener, RenderListener
{
	...
	private void breakJobSite()
	{
		...
		// equip tool
		OPTI.getHax().autoToolHack.equipBestTool(jobSite, false, true,
