...
import net.opticlient.hacks.nukers.NukerModeSetting.NukerMode;
import net.opticlient.hacks.nukers.NukerShapeSetting.NukerShape;
import net.opticlient.settings.BlockSetting;
