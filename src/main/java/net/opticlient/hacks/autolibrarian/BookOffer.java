 ...
 */
package net.opticlient.hacks.autolibrarian;
...
import net.opticlient.OptiTranslator;
	...
	implements Comparable<BookOffer>
{
	...
	{
		DynamicRegistryManager drm = OptiClient.MC.world.getRegistryManager();
	...
	public String getEnchantmentName()
	{
		...
		if(description.getContent() instanceof TranslatableTextContent tr)
			return OptiClient.INSTANCE.getTranslator()
	...
	{
		OptiTranslator translator = OptiClient.INSTANCE.getTranslator();
