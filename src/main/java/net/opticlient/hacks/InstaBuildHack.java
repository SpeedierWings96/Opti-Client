...
import net.opticlient.util.AutoBuildTemplate;
import net.opticlient.util.BlockPlacer;
import net.opticlient.util.BlockPlacer.BlockPlacingParams;
import net.opticlient.util.BlockUtils;
import net.opticlient.util.ChatUtils;
import net.opticlient.util.InteractionSimulator;
import net.opticlient.util.InventoryUtils;
	...
	implements UpdateListener, RightClickListener
{
	...
	{
		OPTI.getHax().autoBuildHack.setEnabled(false);
		OPTI.getHax().templateToolHack.setEnabled(false);
