...
import net.opticlient.hacks.autofish.AutoFishDebugDraw;
import net.opticlient.hacks.autofish.AutoFishRodSelector;
import net.opticlient.hacks.autofish.FishingSpotManager;
import net.opticlient.hacks.autofish.ShallowWaterWarningCheckbox;
	...
	implements UpdateListener, PacketInputListener, RenderListener
{
	...
	protected void onEnable()
	{
		...
		OPTI.getHax().antiAfkHack.setEnabled(false);
