	...
	implements UpdateListener, RenderListener
{
	...
	protected void onEnable()
	{
		...
		OPTI.getHax().followHack.setEnabled(false);
		OPTI.getHax().instantBunkerHack.setEnabled(false);
	...
	public void onRender(MatrixStack matrixStack, float partialTicks)
	{
		...
		for(EasyVertexBuffer buffer : vertexBuffers)
		{
			...
			buffer.draw(matrixStack, OptiRenderLayers.ESP_LINES);
		}
	...
	private class DigTunnelTask extends Task
	{
		...
		public void run()
		{
			...
			OPTI.getHax().autoToolHack.equipBestTool(currentBlock, false, true,
				0);
	...
	private class WalkForwardTask extends Task
	{
		...
		public void run()
		{
			...
			OPTI.getRotationFaker().faceVectorClientIgnorePitch(vec);
	...
	private class FillInFloorTask extends Task
	{
		...
		public void run()
		{
			...
			{
				OPTI.getHax().autoToolHack.equipBestTool(pos, false, true, 0);
				breakBlock(pos);
			}
		}
	...
	private class DodgeLiquidTask extends Task
	{
		...
		public void run()
		{
			...
			OPTI.getRotationFaker().faceVectorClientIgnorePitch(toVec3d(pos3));
	...
	private void placeBlockSimple(BlockPos pos)
	{
		...
		// face block
		OPTI.getRotationFaker().faceVectorPacket(hitVec);
	...
	private boolean breakBlock(BlockPos pos)
	{
		...
		// face block
		OPTI.getRotationFaker().faceVectorPacket(hitVecs[side.ordinal()]);
