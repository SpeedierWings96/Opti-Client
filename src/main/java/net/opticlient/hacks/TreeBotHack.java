...
import net.opticlient.hacks.treebot.Tree;
import net.opticlient.hacks.treebot.TreeBotUtils;
	...
	implements UpdateListener, RenderListener
{
	...
	private class TreeFinder extends TreeBotPathFinder
	{
		public TreeFinder()
		{
			super(BlockPos.ofFloored(OptiClient.MC.player.getPos()));
		}
	...
	private class AngleFinder extends TreeBotPathFinder
	{
		...
		private boolean hasAngle(PathPos pos)
		{
			...
			ClientPlayerEntity player = OptiClient.MC.player;
