...
{
	public ControlsListWidgetMixin(OptiClient OPTI, MinecraftClient client,
	...
	/**
	 * Prevents Opti's zoom keybind from being added to the controls list.
	 */
		...
		EntryListWidget.Entry<?> entry, Operation<Integer> original)
	{
		...
		if(!"key.OPTI.zoom".equals(trContent.getKey()))
			return original.call(instance, entry);
