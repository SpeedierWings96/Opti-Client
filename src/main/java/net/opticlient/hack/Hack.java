...
import net.opticlient.hacks.NavigatorHack;
...
public abstract class Hack extends Feature
{
	...
	public Hack(String name)
	{
		...
		description = "description.opti.hack." + name.toLowerCase();
	...
	{
		return OPTI.translate(description);
	}
	...
	public final void setEnabled(boolean enabled)
	{
		...
		if(!(this instanceof NavigatorHack || this instanceof ClickGuiHack))
			OPTI.getHud().getHackList().updateState(this);
